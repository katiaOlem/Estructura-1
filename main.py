...
## Se insertara la catidad de los elementos a Agregar en la Lista en este caso seran numeros, preguntara si quiere Agregar un nuemero al Inicio de la Lista asi como en el Final se Imprimira la LISTA
